...
function App() {
  const HandleName = () => alert('The profile user is Jabri Yassine' || 'the profile user is unknown')
  return (
    <div className="profile">
      <Profile FullName={'Jabri Yassine'} 
      ...
      <img src='./profileimage.webp' alt='profile'/>
      </Profile>
      <div className='icons'>
        <a href='https://github.com/Jabri-Yassine'>
